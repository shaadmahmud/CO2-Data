...
//Code for 1204 // 
uint8_t sensor1[8] = {0x28, 0x1F, 0xBC, 0x44, 0xD4, 0xE1, 0x3C, 0xCA};
uint8_t sensor2[8] = {0x28, 0xE5, 0xB9, 0x44, 0xD4, 0xE1, 0x3C, 0xA5};
uint8_t sensor3[8] = {0x28, 0x2B, 0xFB, 0x44, 0xD4, 0xE1, 0x3C, 0x43};
uint8_t sensor4[8] = {0x28, 0x1C, 0x20, 0x44, 0xD4, 0xE1, 0x3C, 0x05};
uint8_t sensor5[8] = {0x28, 0x24, 0x46, 0x44, 0xD4, 0xE1, 0x3C, 0xC4};
uint8_t sensor6[8] = {0x28, 0x14, 0xD3, 0x44, 0xD4, 0xE1, 0x3C, 0x4C};
uint8_t sensor7[8] = {0x28, 0x67, 0x17, 0x44, 0xD4, 0xE1, 0x3C, 0xB0};
uint8_t sensor8[8] = {0x28, 0x7F, 0x95, 0x44, 0xD4, 0xE1, 0x3C, 0x02};
uint8_t sensor9[8] = {0x28, 0xD1, 0x43, 0x44, 0xD4, 0xE1, 0x3C, 0x8F};
uint8_t sensor10[8] = {0x28, 0xED, 0x43, 0x44, 0xD4, 0xE1, 0x3C, 0x1F};
uint8_t sensor11[8] = {0x28, 0x88, 0xAD, 0x44, 0xD4, 0xE1, 0x3C, 0x4F};
uint8_t sensor12[8] = {0x28, 0x8C, 0xDD, 0x44, 0xD4, 0xE1, 0x3C, 0xFE};
uint8_t sensor13[8] = {0x28, 0x08, 0x73, 0x44, 0xD4, 0xE1, 0x3C, 0x59};
uint8_t sensor14[8] = {0x28, 0x25, 0xF2, 0x44, 0xD4, 0xE1, 0x3C, 0xA3};
uint8_t sensor15[8] = {0x28, 0xD0, 0x50, 0x44, 0xD4, 0xE1, 0x3C, 0x8A};
uint8_t sensor16[8] = {0x28, 0x8E, 0x8A, 0x44, 0xD4, 0xE1, 0x3C, 0x54};
uint8_t sensor17[8] = {0x28, 0xD4, 0x71, 0x44, 0xD4, 0xE1, 0x3C, 0x63};
uint8_t sensor18[8] = {0x28, 0x1B, 0x0F, 0x44, 0xD4, 0xE1, 0x3C, 0x17};
uint8_t sensor19[8] = {0x28, 0xE8, 0x0F, 0x44, 0xD4, 0xE1, 0x3C, 0x3C};
uint8_t sensor20[8] = {0x28, 0xB8, 0x16, 0x44, 0xD4, 0xE1, 0x3C, 0x9D};
...
uint8_t nodeDeviceEUI[8] = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x56, 0xD0};
uint8_t nodeAppEUI[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFB};
uint8_t nodeAppKey[16] = {0xF7, 0x1B, 0x2E, 0x69, 0x0D, 0x58, 0xCF, 0xB5, 0x18, 0xF0, 0xF3, 0x39, 0x01, 0xE7, 0x90, 0xA7};
