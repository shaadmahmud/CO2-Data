...
//Code for 1205 // 
uint8_t sensor1[8] = {0x28, 0x81, 0x27, 0x44, 0xD4, 0xE1, 0x3C, 0xAF};
uint8_t sensor2[8] = {0x28, 0x6D, 0x65, 0x44, 0xD4, 0xE1, 0x3C, 0x91};
uint8_t sensor3[8] = {0x28, 0x7E, 0x2D, 0x44, 0xD4, 0xE1, 0x3C, 0x44};
uint8_t sensor4[8] = {0x28, 0x36, 0xAE, 0x44, 0xD4, 0xE1, 0x3C, 0x15};
uint8_t sensor5[8] = {0x28, 0xC9, 0x1E, 0x44, 0xD4, 0xE1, 0x3C, 0x0C};
uint8_t sensor6[8] = {0x28, 0x4B, 0xE7, 0x44, 0xD4, 0xE1, 0x3C, 0xDD};
uint8_t sensor7[8] = {0x28, 0xF1, 0x18, 0x44, 0xD4, 0xE1, 0x3C, 0xDC};
uint8_t sensor8[8] = {0x28, 0x18, 0x48, 0x44, 0xD4, 0xE1, 0x3C, 0xF6};
uint8_t sensor9[8] = {0x28, 0xD5, 0xD0, 0x44, 0xD4, 0xE1, 0x3C, 0xAA};
uint8_t sensor10[8] = {0x28, 0x2D, 0x24, 0x44, 0xD4, 0xE1, 0x3C, 0xC0};
uint8_t sensor11[8] = {0x28, 0xC2, 0x00, 0x44, 0xD4, 0xE1, 0x3C, 0x2A};
uint8_t sensor12[8] = {0x28, 0xD4, 0x8F, 0x44, 0xD4, 0xE1, 0x3C, 0x67};
uint8_t sensor13[8] = {0x28, 0x70, 0x7A, 0x44, 0xD4, 0xE1, 0x3C, 0x93};
uint8_t sensor14[8] = {0x28, 0x8D, 0x60, 0x44, 0xD4, 0xE1, 0x3C, 0x6A};
uint8_t sensor15[8] = {0x28, 0x2A, 0x73, 0x44, 0xD4, 0xE1, 0x3C, 0x81};
uint8_t sensor16[8] = {0x28, 0xE7, 0xD9, 0x44, 0xD4, 0xE1, 0x3C, 0xDA};
uint8_t sensor17[8] = {0x28, 0x1F, 0x3B, 0x44, 0xD4, 0xE1, 0x3C, 0x50};
uint8_t sensor18[8] = {0x28, 0x4F, 0x63, 0x44, 0xD4, 0xE1, 0x3C, 0xD5};
uint8_t sensor19[8] = {0x28, 0x89, 0x49, 0x44, 0xD4, 0xE1, 0x3C, 0xBD};
uint8_t sensor20[8] = {0x28, 0xBF, 0x52, 0x44, 0xD4, 0xE1, 0x3C, 0xEE};
...
uint8_t nodeDeviceEUI[8] = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x56, 0xD1};
uint8_t nodeAppEUI[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFC};
uint8_t nodeAppKey[16] = {0xE0, 0xFF, 0x69, 0xBB, 0xA0, 0x5F, 0x09, 0xC5, 0x10, 0xDF, 0x2C, 0xB3, 0x5F, 0xD2, 0xED, 0x06};
