...
uint8_t nodeDeviceEUI[8] = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x50, 0xFE};
uint8_t nodeAppEUI[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF8};
uint8_t nodeAppKey[16] = {0xC6, 0x10, 0x5D, 0xE9, 0x7B, 0x40, 0x66, 0x9A, 0xF6, 0x7A, 0xBA, 0xE9, 0x96, 0xDE, 0x0F, 0xBD};
