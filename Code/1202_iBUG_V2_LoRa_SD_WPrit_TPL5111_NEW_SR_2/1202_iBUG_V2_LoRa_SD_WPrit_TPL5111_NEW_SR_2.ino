...
uint8_t nodeDeviceEUI[8] = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x52, 0x91};
uint8_t nodeAppEUI[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF9};
uint8_t nodeAppKey[16] = {0x26, 0x0F, 0x98, 0xB9, 0x38, 0x63, 0x83, 0xA2, 0x83, 0x6F, 0x03, 0xF1, 0x11, 0xA2, 0x2B, 0x12};
